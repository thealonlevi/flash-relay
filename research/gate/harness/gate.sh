...
echo "building..."
( cd ../.. && CGO_ENABLED=0 go build -o bin/sink ./research/gate/cmd/sink \
  && CGO_ENABLED=0 go build -o bin/loadgen ./research/gate/cmd/loadgen \
  && CGO_ENABLED=0 go build -o bin/relay-uring ./research/gate/cmd/relay-uring \
