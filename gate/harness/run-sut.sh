...
#   sudo env BUILD=uring   SINK=10.0.0.2:9100 bash gate/harness/run-sut.sh
#   sudo env BUILD=netpoll SINK=10.0.0.2:9100 bash gate/harness/run-sut.sh
...
echo "  python3 gate/harness/combine-2box.py $OUT <uring_loadgen.json> <netpoll_loadgen.json>"
